...
namespace RaidForge.Commands
{
    ...
    {
        [Command("raidrefreshcache", description: "Forcefully clears and rebuilds the entire RaidForge cache. Use if the server is not detecting players or bases correctly.", adminOnly: true)]
