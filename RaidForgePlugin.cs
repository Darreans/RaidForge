...
namespace RaidForge
{
    ...
    public class Plugin : BasePlugin
    {
        ...
        public override void Load()
        {
            ...
            try
            {
                TroubleshootingConfig.Initialize(_troubleshootingConfigFile, BepInLogger);
                LoggingHelper.Info($"[Plugin.Load] TroubleshootingConfig.EnableVerboseLogging is currently: {TroubleshootingConfig.EnableVerboseLogging.Value}"); // INFO - Good to see
                ...
                OfflineRaidProtectionConfig.Initialize(_offlineProtectionConfigFile, BepInLogger);
        ...
        {
            LoggingHelper.Debug($"Troubleshooting.cfg setting changed: [{e.ChangedSetting.Definition.Section}] {e.ChangedSetting.Definition.Key} to {e.ChangedSetting.BoxedValue}."); // DEBUG
            if (e.ChangedSetting.Definition.Key == TroubleshootingConfig.EnableVerboseLogging.Definition.Key)
                LoggingHelper.Info($"Verbose logging has been {(TroubleshootingConfig.EnableVerboseLogging.Value ? "ENABLED" : "DISABLED")}."); // INFO - Important
        }
        ...
        {
            LoggingHelper.Debug($"OfflineProtection.cfg setting changed: [{e.ChangedSetting.Definition.Section}] {e.ChangedSetting.Definition.Key} to {e.ChangedSetting.BoxedValue}."); // DEBUG
            if (e.ChangedSetting.Definition.Key == OfflineRaidProtectionConfig.EnableOfflineRaidProtection.Definition.Key)
                LoggingHelper.Info($"Offline Raid Protection has been {(OfflineRaidProtectionConfig.EnableOfflineRaidProtection.Value ? "ENABLED" : "DISABLED")}."); // INFO - Important
        }
        private void OnRaidInterferenceConfigSettingChanged(object sender, SettingChangedEventArgs e)
        {
            LoggingHelper.Debug($"RaidInterference.cfg setting changed: [{e.ChangedSetting.Definition.Section}] {e.ChangedSetting.Definition.Key} to {e.ChangedSetting.BoxedValue}."); // DEBUG
            if (e.ChangedSetting.Definition.Key == RaidInterferenceConfig.EnableRaidInterference.Definition.Key)
                LoggingHelper.Info($"Raid Interference has been {(RaidInterferenceConfig.EnableRaidInterference.Value ? "ENABLED" : "DISABLED")}."); // INFO - Important
        }
        ...
        public override bool Unload()
        {
            ...
            try
            {
                ...
                if (_updaterComponent != null) { UnityEngine.Object.Destroy(_updaterComponent); _updaterComponent = null; LoggingHelper.Debug("ModUpdater component destroyed."); } // DEBUG
